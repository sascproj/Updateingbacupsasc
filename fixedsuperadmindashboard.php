...
<head>
    ...
    <style>
        ...
        /* COMPETITIONS & REGISTRATION TABS SPECIFIC FIX */
        #competitions, #registration, #markEntry, #colleges {
            position: relative;
            z-index: 2;
            width: 100%;
        }
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header text-center">
            <h4><i class="fas fa-user-shield me-2"></i>Super Admin</h4>
        ...
        <nav class="nav flex-column">
            ...
            <a href="#" class="nav-link" data-tab="markEntry">
                <i class="fas fa-clipboard-check me-2"></i><span>Enter Marks</span>
            </a>
            <a href="#" class="nav-link" data-tab="colleges">
                <i class="fas fa-university me-2"></i><span>Manage Colleges</span>
            </a>
            <a href="#" class="nav-link" data-tab="competitions">
                <i class="fas fa-trophy me-2"></i><span>Competitions</span>
            </a>
            <a href="#" class="nav-link" data-tab="registration">
                <i class="fas fa-user-plus me-2"></i><span>Registration Control</span>
            </a>
            <div class="mt-auto">
                ...
                <form id="addCollegeForm">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="collegeCode" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Contact Email</label>
                            <input type="email" class="form-control" id="collegeEmail" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <button type="submit" class="btn btn-primary" id="addCollegeBtn">
    ...
    <script>
        ...
        document.getElementById('addCollegeForm').addEventListener('submit', function(e) {
            ...
            showAlert('College added successfully! Login credentials generated.', 'success');
        });
