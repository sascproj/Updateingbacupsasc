...
/* Ensure main content starts after sidebar */
.main-content {
    margin-left: 250px;
    padding: 20px;
    background-color: var(--light-bg);
...
/* Make sure sidebar is fixed and on top */
.sidebar {
    position: fixed;
    left: 0;
    top: 0;
...
/* Fix for dashboard tab (should not have extra padding) */
#dashboard {
